...
|	ice_skating	|	ICE_SKATING	|	NA	|
|	in_vehicle	|	IN_VEHICLE	|	NA	|
|	interval_training	|	INTERVAL_TRAINING	|	NA	|
|	jump_rope	|	JUMP_ROPE	|	NA	|
|	kayaking	|	KAYAKING	|	NA	|
|	kettlebell_training	|	KETTLEBELL_TRAINING	|	NA	|
|	kick_scooter	|	KICK_SCOOTER	|	NA	|
|	kickboxing	|	KICKBOXING	|	NA	|
|	kitesurfing	|	KITESURFING	|	HKWorkoutActivityTypeMartialArts	|
|	lacrosse	|	NA	|	HKWorkoutActivityTypeLacrosse	|
|	martial_arts	|	MARTIAL_ARTS	|	NA	|
|	meditation	|	MEDITATION	|	HKWorkoutActivityTypeMindAndBody	|
|	martial_arts.mixed	|	MIXED_MARTIAL_ARTS	|	NA	|
|	on_foot	|	ON_FOOT	|	NA	|
...
|	scuba_diving	|	SCUBA_DIVING	|	NA	|
|	skateboarding	|	SKATEBOARDING	|	NA	|
...
|	weightlifting	|	WEIGHTLIFTING	|	NA	|
|	wheelchair	|	WHEELCHAIR	|	NA	|
|	windsurfing	|	WINDSURFING	|	NA	|
